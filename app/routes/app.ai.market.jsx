...
- 3 recommandations IA pour la boutique Shopify
  ...
  if (iaLevel === "PREMIUM") {
    prompt = `
Tu es Velto IA Marché PREMIUM.

Niche : ${niche}

Donne :
- 5 tendances de marché avancées
- 5 segments de clients détaillés
- Analyse IA de la concurrence
- Opportunités à moyen / long terme
...
export default function AiMarket() {
  ...
  return (
    <VeltoLayout title="IA Marché – Velto">
      <div className="space-y-6">
        ...
        <p className="text-gray-700">
          Analyse IA du marché pour votre niche et votre boutique.
        </p>
